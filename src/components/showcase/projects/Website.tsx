    ...
    return (
        <div className="site-page-content">
            ...
            <div className="text-block">
                ...
                <br />
                <p>
                    yanquankun.cn is my portfolio website, and also the website
                    you are on right now. This project was an absolute joy to
                    make and challenged me both technically and creatively.
                    Early in 2024, I knew I wanted to make an interactive
                    portfolio to aid my job search. I eventually got the idea
                    for this site around early February and began development
                    early March. I've been developing it alongside my last
                    semester at school and if you are reading this, it's pretty
                    much done!
                </p>
                <br />
                ...
                <ul>
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://yanquankun.cn"
                        >
                            <p>
                                <b>[3D Site]</b> - yanquankun.cn
                            </p>
                        </a>
                    </li>
                    <li>
